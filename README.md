...
- **[Math Muncher](https://github.com/ThaiDuongVu/MathMuncher)**: a relaxing block-pushing puzzle game where you do math and feed a hungry monster.  (C#/Unity). Available on **[Steam](https://store.steampowered.com/app/3450940/Math_Muncher/)**.
<img src="./images/mathmuncher.jpg" height=150 alt="mathmuncher">

- **[Coupling](https://github.com/ThaiDuongVu/Coupling)**: a physics-based puzzle platformer game where the player controls two characters chained together by a link.  (C#/Unity). Available on **[Steam](https://store.steampowered.com/app/2753220/Coupling/)**.
<img src="./images/coupling.png" height=150 alt="coupling">
